...
export const SETTINGS_SCHEMA = {
		...
		ui: {
			...
			options: [
				...
				},
				{
					value: "codex",
					label: "OpenAI",
					description: "OpenAI's native web_search (uses ChatGPT OAuth)",
				},
				{
					value: "gemini",
					label: "Gemini",
					description: "Google Search grounding via Gemini (uses Google OAuth)",
				},
	...
	"providers.image": {
		type: "enum",
		values: ["auto", "openai", "gemini", "antigravity"] as const,
		default: "auto",
		ui: {
			tab: "providers",
			...
			options: [
				{
					value: "auto",
					label: "Auto",
					description: "Priority: GPT model image tool > Antigravity > Gemini",
				},
				{ value: "openai", label: "OpenAI", description: "Uses the active GPT Responses/Codex model" },
				{ value: "gemini", label: "Gemini", description: "Requires GEMINI_API_KEY" },
				{ value: "antigravity", label: "Antigravity", description: "Requires login with Antigravity" },
			],
		},
	},
