 ...
 *
 * Supports Anthropic, Perplexity, Exa, Brave, Jina, Kimi, Gemini, OpenAI code backend, xAI, Z.AI, SearXNG, Synthetic, Insane Search, and DuckDuckGo providers with automatic fallback.
 */
